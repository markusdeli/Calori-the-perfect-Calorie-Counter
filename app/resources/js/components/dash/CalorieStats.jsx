...
/**
 * Eine Card-Component die ein Diagramm der
 */
export default class CalorieStats extends EventListeningComponent {
    ...
    /**
     * Holt sich die aktuellen Kalorienzahlen aus dem Repository und
     * aktualisiert das Diagramm dementsprechend
     */
    async loadStats() {
        ...
        const calories = [0, 0, 0, 0, 0, 0, 0]; // 7 Tage
        try {
            ...
            for (let i = 0; i < 7; i++) {
                ...
                calories[i] = await this._mealRepo.getCaloriesFromTo(
                    currentStart,
